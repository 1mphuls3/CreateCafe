...
public class ModFoods {
    ...
    public static final Function<MobEffect, FoodProperties> HOT_COFFEE_DRINK = (effect -> (new FoodProperties.Builder())
            .effect(() -> new MobEffectInstance(EffectRegistry.WARMTH.get(), 10*20, 0), 1.0F)
            .effect(() -> effect != null ? new MobEffectInstance(effect, 10*20, 1) :
                    new MobEffectInstance(MobEffects.WATER_BREATHING, 0, 0, true, false), 1.0F)
            .nutrition(8).saturationMod(0.2F).alwaysEat().build());
}
